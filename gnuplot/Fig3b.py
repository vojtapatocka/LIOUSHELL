...
dlist = ["N300_hf001", "N300_hfP", "N200_hfP", "N100_hfP", "N300_hf1", "N300_hfinf"]
dlistfb = []
...
ax2.set_title('b) Negative load')
ax2.set_rmin(0.0)
ax2.set_rmax(1.1*max(colL))
ax2.set_thetamin(0)
ax2.set_thetamax(90)
ax2.legend(fontsize = 15, loc='lower right', bbox_to_anchor=(0.8, 0.0), framealpha=1.0)
ax2.grid(True)
...
plt.savefig("../figs/Fig3b.png", bbox_inches='tight')
plt.clf()
