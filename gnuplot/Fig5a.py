...
dlist = ["P300_lon0", "P300_lon20", "P300_lon40", "P300_lon60", "P300_lon80", "P300_lon90"]
dlistfb = []
for dname in dlist: dlistfb.append(dname + '_fb')
# plotting also fb50 results (with dashed lines)
dlist += dlistfb 
clist = ["C0", "C1", "C2", "C3", "C4", "C5", "C6"]
tlist = ["300", "300", "300", "300", "300", "300"]
lonlist = ["0°", "20°", "40°", "60°", "80°", "90°"]
...
ax2.set_title('a) Positive load, formed in the cold band')
ax2.set_rmin(0.0)
ax2.set_rmax(1.1*max(colL))
ax2.set_thetamin(0)
ax2.set_thetamax(90)
ax2.legend(fontsize = 15, loc='lower right', bbox_to_anchor=(1.03, 0.72), framealpha=1.0)
ax2.grid(True)
...
ax2.set_rticks([0, 30, 60, 90]) #np.linspace(0.,  90., 4, endpoint=True) )
...
plt.savefig("../figs/Fig5a.png", bbox_inches='tight')
plt.clf()
